function mss($, _){
    ...
    function MSSTree(layer){
        ...
        function Leafcalc(seed, phi){
            return [algorithm(seed + phi.toString()), 0];
        };
        ...
        function Treehash(seed){
            ...
            this.feed = function(phi){
                ...
                while(
                    ...
                    Leaf[0] = algorithm(
                        $.nodejs.buffer.Buffer.concat([topNode[0], Leaf[0]])
                    );
        ...
        this.root = function(seed){
            ...
            console.log(treehash.get_stack());
            return treehash.get_stack()[0][0];
        };

        this.sign = function(seed, i, message){
        };

        this.verify = function(otsPubKey, otsSig, auths, compare){
