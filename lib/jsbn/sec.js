...
function sm2fp192(){
    ...
    var p = fromHex("BDB6F4FE3E8B1D9E0DA8C0D46F4C318CEFE4AFE3B6B8551F");
    var a = fromHex("BB8E5E8FBC115E139FE6A814FE48AAA6F0ADA1AA5DF91985");
    var b = fromHex("1854BEBDC31B21B7AEFC80AB0ECD10D5B1B3308E6DBF11C1");
    var n = fromHex("BDB6F4FE3E8B1D9E0DA8C0D40FC962195DFAE76F56564677");
    var h = BigInteger.ONE;
    var curve = new ECCurveFp(p, a, b);
    var G = curve.decodePointHex("04"
...
module.exports = function(bi, eccurvefp){
    ...
    return function(name){
        return {
            ...
            "secp224r1": secp224r1(),
            "secp256r1": secp256r1(),
//            "sm2fp192": sm2fp192(),   // problematisch
        }[name] || null;
    };
};
